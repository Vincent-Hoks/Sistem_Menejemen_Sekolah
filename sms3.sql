...
-- Dumping structure for table sistem_menejemen_sekolah.trx_spp
CREATE TABLE IF NOT EXISTS `trx_spp` (
  `id_trx_spp` int(11) NOT NULL AUTO_INCREMENT,
  `id_siswa` bigint(20) unsigned NOT NULL,
  `id_spp` int(11) DEFAULT NULL,
  `nominal_bayar` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_trx_spp`),
  KEY `FK_trx_spp_m_spp` (`id_spp`),
  KEY `FK_trx_spp_m_siswa` (`id_siswa`),
  CONSTRAINT `FK_trx_spp_m_siswa` FOREIGN KEY (`id_siswa`) REFERENCES `m_siswa` (`id_siswa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_trx_spp_m_spp` FOREIGN KEY (`id_spp`) REFERENCES `m_spp` (`id_spp`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table sistem_menejemen_sekolah.trx_spp: ~1 rows (approximately)
REPLACE INTO `trx_spp` (`id_trx_spp`, `id_siswa`, `id_spp`, `nominal_bayar`) VALUES
	(1, 2, 1, 20000);
